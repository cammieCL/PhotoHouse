...
<div class="super_container">
	...
	<div class="super_container_inner">
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Tehnology</div>
				</div>
			</div>
		</div>
		...
		<?php
			...
			session_start();
			$user = $_SESSION['admin'];
			$sql = "SELECT * from produse Where categorie LIKE 'Tehnology' ORDER BY data_publicarii desc";
			$numesite = "tehnology.php";
