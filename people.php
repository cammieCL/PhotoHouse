...
<div class="super_container">
			...
			<header class="header">
				...
				<div class="header_content d-flex flex-row align-items-center justify-content-start">
					...
					<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
						...
						<!-- Cart -->
						<div class="cart"><a href="people.php"><div><img class="svg" src="images/fotografiile_mele.png" alt=""></div></a></div>
						<!-- Phone -->
	...
	<div class="super_container_inner">
		...
		<?php
			...
			session_start();
			$user = $_SESSION['admin'];
			$sql = "SELECT * from produse Where categorie LIKE 'People' ORDER BY data_publicarii desc";
			$numesite = "people.php";
