...
<div class="super_container">
		...
		if ($_SESSION['photo']) { ?>
			...
			<header class="header">
				...
				<div class="header_content d-flex flex-row align-items-center justify-content-start">
					...
					<nav class="main_nav">
						<ul class="d-flex flex-row align-items-start justify-content-start">	
							<li class="active"><a href="indexlogat.php">Explore</a></li>
							<li><a href="collection.php">Collection</a> </li>
							<li><a href="hottest.php">Hottest 50</a></li>
							<li class="active"><a href="">Categories</a></li>
							<li><a href="inspire.php">Inspire</a></li>
	...
	<div class="super_container_inner">
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Travel</div>
				</div>
			</div>
		</div>
		...
		<?php
			...
			session_start();
			$user = $_SESSION['admin'];
			$sql = "SELECT * from produse Where categorie LIKE 'Travel' ORDER BY data_publicarii desc";
			$numesite = "travel.php";
