...
<div class="super_container">
    ...
    <br> <br> <br> <br> <br> <br> <br>
     <p style = "font-size: 30px; color: black; margin-left: 500px"><strong>You can contact us at the email adress:</strong></p>
     <p style = "font-size: 30px; color: black; margin-left: 500px"> <strong> contact@photohouse.com </strong> </p> 
     <br> <br> 
     <p style = "font-size: 30px; color: black; margin-left: 200px"> <strong> Câmpeni, Romania</strong> </p>
